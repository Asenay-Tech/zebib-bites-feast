  ...
  const t = (key: string): string => {
    const translations: Record<Language, Record<string, string>> = {
      de: {
        ...
        "imprint.company": "Firma",
        "imprint.address": "Anschrift",
        "imprint.contact": "Kontakt",
        "imprint.responsible": "Verantwortlich i.S.d. § 18 Abs. 2 MStV",
        "imprint.vat": "Umsatzsteuer-ID",
        "imprint.vatNumber": "DE-XXXXXXX",
        "imprint.liability.title": "Haftungsausschluss",
        "imprint.liability.content": "Die Inhalte unserer Seiten wurden mit größter Sorgfalt erstellt. Für die Richtigkeit, Vollständigkeit und Aktualität der Inhalte können wir jedoch keine Gewähr übernehmen.",
        "imprint.externalLinks.title": "Externe Links",
      ...
      en: {
        ...
        "imprint.responsible": "Responsible according to § 18 Abs. 2 MStV",
        "imprint.vat": "VAT ID",
        "imprint.vatNumber": "DE-XXXXXXX",
        "imprint.liability.title": "Liability Disclaimer",
        "imprint.liability.content": "The contents of our pages have been created with the greatest care. However, we cannot guarantee the accuracy, completeness, and timeliness of the content.",
        "imprint.externalLinks.title": "External Links",

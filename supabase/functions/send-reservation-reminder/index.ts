...
import { ReservationReminderEmail } from "./_templates/reservation-reminder.tsx";
...
serve(async (req) => {
  ...
  try {
    ...
    const html = await renderAsync(
      React.createElement(ReservationReminderEmail, {
        name,
        date,
        time,
        people,
    ...
    const { data, error } = await resend.emails.send({
      ...
      to: [email],
      subject: "Reminder: Your Reservation at Zebib Foods Today",
      html,
    });
